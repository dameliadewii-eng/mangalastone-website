...
const Alerts = () =>{
    ...
    const confirmDelete = () => {
        axios.delete('http://localhost:3000/alerts/remove/'+alertToDelete).then((res)=>{
    ...
    const handleSubmit = async() =>{
        try{
            ...
            let res = await axios.post('http://localhost:3000/alerts/add',{
                title,
                description,
                category
            },{
                            ...
                            <table className="table table-bordered" id="dataTable" width="100%" cellSpacing="0" style={{backgroundColor:'white'}}>
...

                                {
                                    alerts && alerts.map((alert,index)=>{
                                        ...
                                        <td className="text-center"><a className="text-danger"><i className="fas fa-trash"><FaTrash onClick={(event,alertId=alert._id)=>{
                  ...
                  <form onSubmit={handleSubmit} encType="multipart/form-data">
                    <div className="row">
                      <div className="col-md-6 form-group main_input pln">
                        ...
                        />
                        {
                          titleError && <p style={{color:'deeppink', paddingTop:'5px'}}>Enter a title</p>
                        }
                      </div>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div className="form-group">
                        <textarea
                          ...
                          style={{ width: "100%",border: descriptionError && '2px solid deeppink' }}
                          name="description"
                          rows="5"
                          cols="40"
                          maxLength="1000"
                        ...
                        ></textarea>
                        {
                            descriptionError && <p style={{color:'deeppink'}}>Enter a description</p>
                        }
                      </div>
                    </div>
                    <div className="row">
                      <div className="col-md-6 form-group main_input pln">
                        ...
                        />
                        {
                          categoryError && <p style={{color:'deeppink', paddingTop:'5px'}}>Enter a category</p>
                        }
                      </div>
                    </div>
                    <div
