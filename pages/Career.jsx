...
const Career = () => {
  ...
  const addCareer = async () => {
    ...
    try {
      if (cv) {
        const res = await axios.post("http://localhost:3000/careers/add", formData, config);
        console.log(res);
  ...
  return (
    <>
                  ...
                  <form onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    >
                      ...
                      <select
                        ...
                        name="specialization"
                        // required 
                        style={{ border: specializationError && '1px solid deeppink'}}
                      >
                    ...
                    {
                      specializationError && <p style={{color:'deeppink'}}>Select your specialization</p>
                    }
                    <div
      ...
      >
        ...
        <button onClick={addCareer} className="btn btn-primary">Yes</button>
        <button onClick={() => setIsModalOpen(false)} className="btn btn-secondary">No</button>
          </div>
