  ...
  <div className="card">
    ...
    <div className="card-body">
      ...
      <div className="card-content">
        ...
        <a onClick={(event) =>{
          event.preventDefault();
          navigate('/add-enrollment',{state:{course:'Web Development'}});
...
<div className="card-wrapper col-lg-4 col-md-6 col-xs-12">
  <div className="card">
    <div className="card-img-wrapper">
      <img className="card-img-top" src={androidandios} alt="Card image cap"/>
    </div>
    <div className="card-body">
      ...
      <a onClick={(event) =>{
        event.preventDefault();
        navigate('/add-enrollment',{state:{course:'Android/IOS developement'}});
      }}  className="btn btn-primary">Enroll Now</a>
    </div>
  </div>
</div>
...
<div className="card-wrapper col-lg-4 col-md-6 col-xs-12">
  <div className="card">
    <div className="card-img-wrapper">
      <img className="card-img-top" src={graphics} alt="Card image cap"/>
    </div>
    <div className="card-body">
      <h5 className="card-title">GRAPHIC DESIGNING</h5>
      <div className="card-text">
          <ul className="">
                    <li>WorkFlow and Usage of Adobe Photoshop & Illustrator</li>
                    <li>Principles of Design Elements of design and colors.</li>
                    <li>Branding, Brand identity, Layout grid system TypoGraphichy</li>
      ...
      <a onClick={(event) =>{
        event.preventDefault();
        navigate('/add-enrollment',{state:{course:'Graphic Designing'}});
      }} className="btn btn-primary">Enroll Now</a>
    </div> 
  </div>
</div>
...
<div className="card-wrapper col-lg-4 col-md-6 col-xs-12">
  <div className="card">
    <div className="card-img-wrapper">
      <img className="card-img-top" src={amazon} alt="Card image cap"/>
    </div>
    <div className="card-body">
      ...
      <a onClick={(event) =>{
        event.preventDefault();
        navigate('/add-enrollment',{state:{course:'Amazon Virtual Assistant'}});
      }} className="btn btn-primary">Enroll Now</a>
    </div>
  </div>
</div>
<div className="card-wrapper col-lg-4 col-md-6 col-xs-12">
  <div className="card">
    <div className="card-img-wrapper">
      <img className="card-img-top" src={msOffice} alt="Card image cap"/>
    </div>
    <div className="card-body">
      ...
      <div className="card-text">
          <ul className="">
                ...
                <li>Learn to creat Automated Spreadsheet using Ms Excel</li>
